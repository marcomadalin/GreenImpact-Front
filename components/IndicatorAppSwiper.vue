  ...
  <div>
    <div v-swiper:mySwiper="settingsModified()">
      <div class="swiper-wrapper">
        <div v-for="item in apps" :key="item.id" class="swiper-slide">
          <v-btn
            depressed
            height="160"
            width="160"
    ...
    <div style="position: relative" class="arrows-position">
      <div
        ...
        :class="'swiper-button-prev swiper-button-prev-app-' + customArrowClass"
      ></div>
      <div
        v-show="$vuetify.breakpoint.mdAndUp"
        :class="'swiper-button-next swiper-button-next-app-' + customArrowClass"
      ></div>
    </div>
  </div>
</template>
  ...
  methods: {
    settingsModified() {
      ...
      settingsModified.navigation = {
        nextEl: '.swiper-button-next-app-' + this.customArrowClass,
        prevEl: '.swiper-button-prev-app-' + this.customArrowClass,
      }
