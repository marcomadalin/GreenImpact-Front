    ...
    <v-stepper-content step="1" editable>
      ...
      <v-container>
        <v-row>
          <v-col cols="12" md="4">
            <v-text-field
              v-model.number="form.startQuantitativeValue"
              type="number"
              :suffix="
          ...
          <v-col cols="12" md="4">
            <v-text-field
              v-model.number="form.endQuantitativeValue"
              type="number"
              :suffix="
                indicatorDto.quantitativeMeasurementUnitDTO
                  .quantitativeMeasurementUnit
  ...
  data() {
    return {
      ...
      form: {
        ...
        startQuantitativeValue: this.value.startQuantitativeValue || null,
        endQuantitativeValue: this.value.endQuantitativeValue || null,
        startDate:
